              ...
              <div className="flex px-2.5 items-center gap-4">
                ...
                <div className="flex flex-col gap-1.5 w-full">
                  ...
                  <button
                    ...
                    className="self-end hidden px-4 py-2 rounded-full hover:cursor-pointer glassmorphism-btn text-sm"
                  >
                    Comment
                  </button>
                </div>
                            ...
                            {isEditing && isAuthor ? (
                              <div className="flex items-center gap-3">
                                <input
                                  ...
                                  className="glassmorphism-input w-[25vw]"
                                />
                                <button
                                  onClick={() => {
                                    handleEditComment(
                                  ...
                                  className="glassmorphism-btn text-sm"
                                >
                                  Update
                                </button>
                              </div>
